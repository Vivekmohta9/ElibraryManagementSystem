...
namespace ELibraryMgmtSystem.Controllers
{
    public class OrdersController : ApiController
    {
        ...
        [Route("api/Order_DetailsByUserId/{userId}")]
        public IHttpActionResult GetDocument_DetailsByDiscId(int userId)
        {
            var filterOrderDetails = from order in db.Orders
